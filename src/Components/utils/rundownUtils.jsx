...
//     // description: rawRundownData.description || 'Generated rundown for Jakarta exploration',
//     itinerary: (rawRundownData.itinerary || []).map((item, index) => ({
//       order: index + 1,
//       // destinationId: item.destinationId || null,
//       destinationName: item.activity || item.name || 'Unknown Destination',
//       // location: item.location || '',
//       // estimatedTime: item.estimatedTime || '2 hours',
//       // estimatedCost: item.estimatedCost || 0,
//       // category: item.category || 'wisata',
//       notes: item.notes || '',
//       // Add coordinates if available
//       // coordinates: item.coordinates || null
//       price: item.price // ini baru gua  masukin, apakah berhasil menyimpan data price nya tidak?
//     })),
//     budgetEstimation: rawRundownData.budgetEstimation || 'Belum dihitung',
//     totalDestinations: (rawRundownData.itinerary || []).length,
//     // tags: rawRundownData.tags || ['jakarta', 'wisata'],
//     // tripType: rawRundownData.tripType || 'general',
//     estimatedDuration: rawRundownData.tripDetails.preferences.duration || '1 day'
//   };
// };
